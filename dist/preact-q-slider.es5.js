...
var SliderComponent = /** @class */ (function (_super) {
    ...
    SliderComponent.prototype.render = function () {
        return (this.props.slides.length > 0 && (h("div", { ref: this.handleSliderRef, className: classNames("q-slider__slider", {
            ...
            this.props.showArrows &&
                this.props.slides.length > 1 && (h(SliderNavigation, { onNextArrowClick: this.handleNextClick, onPrevArrowClick: this.handlePrevClick, nextArrow: this.props.nextArrow, prevArrow: this.props.prevArrow })),
            this.props.showPagination &&
                this.props.slides.length > 1 && (h(SliderPagination, { slidesToShow: this.props.slidesToShow, onPaginationItemClick: this.handlePaginationItemClick, onPaginationItemRender: this.props.onPaginationItemRender })))));
    };
...
var QSlider = /** @class */ (function (_super) {
    ...
    QSlider.prototype.render = function () {
        return (this.state.ready && (h(preact_2, { store: this.store },
