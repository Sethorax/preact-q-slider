(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('preact'), require('classnames'), require('preact-html-converter'), require('unistore')) :
    typeof define === 'function' && define.amd ? define(['exports', 'preact', 'classnames', 'preact-html-converter', 'unistore'], factory) :
    (factory((global.preactQSlider = {}),global.preact,global.classNames,global.preactHtmlConverter,global.createStore));
}(this, (function (exports,preact,classNames,preactHtmlConverter,createStore) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var connectClass = function (mapStateToProps, actions) { return function (component) {
        return preact_1(mapStateToProps, actions)(function (props) { return preact.h(component, props); });
    }; };
    ...
    var SliderPaginationComponent = /** @class */ (function (_super) {
        ...
        SliderPaginationComponent.prototype.renderPaginationItem = function (key, isCurrent) {
            ...
            return this.props.paginationItem ? preact.cloneElement(this.props.paginationItem, props) : preact.h("div", props);
        };
        SliderPaginationComponent.prototype.render = function () {
            var _this = this;
            return (preact.h("div", { className: "q-slider__pagination" }, this.getNavigatableSlides().map(function (_, index) { return _this.renderPaginationItem(index, index === _this.props.currentSlideIndex); })));
        };
    ...
    var SliderNavigation = /** @class */ (function (_super) {
        ...
        SliderNavigation.prototype.render = function () {
            var nextArrow = this.props.nextArrow ? preact.cloneElement(this.props.nextArrow, { onClick: this.props.onNextArrowClick }) : preact.h("div", { className: "q-slider__arrow q-slider__arrow_next", onClick: this.props.onNextArrowClick });
            var prevArrow = this.props.prevArrow ? preact.cloneElement(this.props.prevArrow, { onClick: this.props.onPrevArrowClick }) : preact.h("div", { className: "q-slider__arrow q-slider__arrow_prev", onClick: this.props.onPrevArrowClick });
            return (preact.h("div", { className: "q-slider__navigation" },
                prevArrow,
                nextArrow));
        };
    ...
    var SlideTrackComponent = /** @class */ (function (_super) {
        ...
        SlideTrackComponent.prototype.renderSlidingTrack = function () {
            ...
            return (preact.h("div", { className: classNames("q-slider__track", { "q-slider__track_no-transition": this.props.isGrabbing }), style: { transform: this.props.vertical ? "translate3d(0, " + trackOffset + "%, 0)" : "translate3d(" + trackOffset + "%, 0, 0)" } }, this.props.slides.map(function (slide, index) { return (preact.h("div", { key: index, onMouseDown: _this.handleSlideMouseTouchDown, onTouchStart: _this.handleSlideMouseTouchDown, onClick: function (event) { return _this.handleSlideClick(event, index); }, className: "q-slider__slide", "data-slide-index": index, style: _this.props.vertical ? { height: slideWidth + "%" } : { width: slideWidth + "%" } }, slide)); })));
        };
        SlideTrackComponent.prototype.renderFadingTrack = function () {
            return (preact.h("div", { className: classNames("q-slider__track q-slider__track_fading-track", { "q-slider__track_fading-track_is-fading": this.props.isFading }) },
                preact.h("div", { className: classNames("q-slider__slide q-slider__slide_is-current", { "q-slider__slide_is-active": this.activeFadeSlide === 0 }), style: {
                ...
                preact.h("div", { className: classNames("q-slider__slide q-slider__slide_is-next", { "q-slider__slide_is-active": this.activeFadeSlide === 1 }), style: {
        ...
        SliderComponent.prototype.render = function () {
            return (this.props.slides.length > 0 && (preact.h("div", { ref: this.handleSliderRef, className: classNames('q-slider__slider', { 'q-slider__slider_is-vertical': this.props.vertical, 'q-slider__slider_no-sliding': this.props.slides.length <= this.props.slidesToShow }) },
                preact.h(DraggableTrack, { slidesToShow: this.props.slidesToShow, vertical: this.props.vertical, gotoSlide: this.gotoSlide, getSliderWidth: this.getSliderWidth },
                    preact.h(SlideTrack, { fade: this.props.fade, fadeDuration: this.props.fadeDuration, vertical: this.props.vertical, slidesToShow: this.props.slidesToShow, onSlideClick: this.props.onSlideClick })),
